...
Weather.create(user_id: admin.id, region_id: northwest.id, description: "heat wave in the north", temp: 6, wind: 1, rain: 2, cloud: 1)
Weather.create(user_id: admin.id, region_id: south.id, description: "somehow, its freezing in the desert", temp: 1, wind: 2, rain: 1, cloud: 1)
...
Weather.create(user_id: admin.id, region_id: southeast.id, description: "hurricane season", temp: 2, wind: 6, rain: 4, cloud: 6)